...
\name{Abdurrahman}{Işık}
\position{Senior Software Engineer{\enskip\cdotp\enskip}Technical Lead}
\address{Tallinn, Estonia}

\mobile{(+372) 5814-8898}
\email{isikabdurrahman@yahoo.com}
\homepage{abdurrahman.github.io}
\github{abdurrahman}
\linkedin{isikabdurrahman}
% \gitlab{gitlab-id}
